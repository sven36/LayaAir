(function (window, document, Laya) {
	...
	var VectorGraphManager = laya.utils.VectorGraphManager,
		WordText = laya.utils.WordText;
	...
	var RenderTargetMAX = (function () {
		...
		__static(RenderTargetMAX,
			['_matrixDefault', function () {
				return this._matrixDefault = new Matrix();
			}]);
	...
	var GlUtils = (function () {
		...
		//clip ={ width:746,height:170  } tx 0 ty 0 texW 428 texH 80 uv m 0 0 0 0
	...
	var Shader = (function (_super) {
		...
		__proto.uploadArray = function (shaderValue, length, _bufferUsage) {
			...
			var one, shaderCall = 0,
				uploadArrayCount = Shader._uploadArrayCount++;
		...
		__proto.parseOne = function (attributes, uniforms, words, i, word, b) {
			var one = {
				type: Shader.shaderParamsMap[words[i + 1]],
				name: words[i + 2],
