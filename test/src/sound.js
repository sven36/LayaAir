var soundeModule = function (PIXI, PIXI, pixiUtil, PIXI) {
    "use strict";
    var i = function () {
        function t(t, e) {
            this._output = e,
                ...
                set: function (t) {
                    ...
                    if (this._filters && (this._filters.forEach(function (t) {
                        ...
                        t.forEach(function (t) {
                            null === n ? e._input.connect(t.destination) : n.connect(t.destination),
                                n = t
                        }),
    ...
    var f = (function (t) {
        ...
        return u(n, t),
            ...
            n.prototype.refresh = function () {
                if (this._source) {
                    ...
                    h.setParamValue(this._gain.gain, i * o * n),
                        h.setParamValue(this._source.playbackRate, this._speed * e.speed * t.speed)
                }
            }
            ,
            n.prototype.refreshPaused = function () {
                ...
                n !== this._pausedReal && ((this._pausedReal = n) ? (this._internalStop(),
            ...
            Object.defineProperty(n.prototype, "_enabled", {
                set: function (t) {
                    PIXI.Ticker.shared.remove(this._updateListener, this),
                        t && PIXI.Ticker.shared.add(this._updateListener, this)
                },
                enumerable: !0,
                configurable: !0
            }),
            ...
            n.prototype.init = function (t) {
                (this._media = t).context.events.on("refresh", this.refresh, this),
    ...
    var d = (function (t) {
        ...
        return u(e, t),
            Object.defineProperty(e.prototype, "script", {
                get: function () {
                    return this._script || (this._script = this.context.audioContext.createScriptProcessor(e.BUFFER_SIZE),
    ...
    var y = function (t) {
        function e() {
            ...
            return u.connect(s),
                ...
                o._offlineCtx = new e.OfflineAudioContext(1, 2, i.OfflineAudioContext ? r.sampleRate : 44100),
                o._unlocked = !1,
                o.compressor = s,
                o.analyser = u,
                o.events = new pixiUtil.EventEmitter,
                o.volume = 1,
                o.speed = 1,
                o.muted = !1,
                o.paused = !1,
                "running" !== r.state && (o._unlock(),
    ...
    var g = {
        ...
        DistortionFilter: function (t) {
            function e(e) {
                ...
                if (!p().useLegacy) {
                    ...
                    return (n = t.call(this, o) || this)._distortion = o,
                        n.amount = e,
                        n
                }
                ...
                Object.defineProperty(e.prototype, "amount", {
                    ...
                    set: function (t) {
                        ...
                        for (var e, n = new Float32Array(44100), o = Math.PI / 180, i = 0; i < 44100; ++i)
                            e = 2 * i / 44100 - 1,
                                n[i] = (3 + t) * e * 20 * o / (Math.PI + t * Math.abs(e));
        ...
        StereoFilter: function (t) {
            function e(e) {
                ...
                if (!p().useLegacy) {
                    ...
                    return r = s.createStereoPanner ? o = s.createStereoPanner() : ((i = s.createPanner()).panningModel = "equalpower",
                        i),
            ...
            return u(e, t),
                Object.defineProperty(e.prototype, "pan", {
                    ...
                    set: function (t) {
                        this._pan = t,
                            this._stereo ? h.setParamValue(this._stereo.pan, t) : this._panner.setPosition(t, 0, 1 - Math.abs(t))
                    },
                    enumerable: !0,
                    configurable: !0
                }),
        ...
        ReverbFilter: function (t) {
            function e(e, n, o) {
                ...
                var i = this;
                if (!p().useLegacy)
                    return (i = t.call(this, null) || this)._seconds = i._clamp(e, 1, 50),
            ...
            return u(e, t),
                ...
                Object.defineProperty(e.prototype, "seconds", {
                    ...
                    set: function (t) {
                        this._seconds = this._clamp(t, 1, 50),
                            this._rebuild()
                    },
                    enumerable: !0,
                    configurable: !0
                ...
                Object.defineProperty(e.prototype, "decay", {
                    ...
                    set: function (t) {
                        this._decay = this._clamp(t, 0, 100),
                            this._rebuild()
                    },
                    enumerable: !0,
                    configurable: !0
                ...
                e.prototype._rebuild = function () {
                    for (var t, e = p().context.audioContext, n = e.sampleRate, o = n * this._seconds, i = e.createBuffer(2, o, n), r = i.getChannelData(0), s = i.getChannelData(1), u = 0; u < o; u++)
                        t = this._reverse ? o - u : u,
                            r[u] = (2 * Math.random() - 1) * Math.pow(1 - t / o, this._decay),
                            s[u] = (2 * Math.random() - 1) * Math.pow(1 - t / o, this._decay);
        ...
        MonoFilter: function (t) {
            function e() {
                ...
                if (!p().useLegacy) {
                    ...
                    return i.connect(o),
                        (e = t.call(this, i, o) || this)._merger = i,
                        e
                }
            ...
            n.prototype.play = function (t) {
                ...
                this._speed = s,
                    ...
                    this._source.onloadedmetadata = function () {
                        o._source && (o._source.currentTime = i,
                            o._source.onloadedmetadata = null,
                            o.emit("progress", i, o._duration),
                            PIXI.Ticker.shared.add(o._onUpdate, o))
                    }
                    ,
                    this._source.onended = this._onComplete.bind(this),
                    this._source.play(),
    ...
    var j = ["mp3", "ogg", "oga", "opus", "mpeg", "wav", "m4a", "aiff", "wma", "mid"], F = (E = {
        m4a: "mp4",
        oga: "ogg"
    },
    ...
    function S(t) {
        ...
        if (e.test(n)) {
            ...
            return "string" != typeof t && (t.extension = r,
                t.url = c),
                c
        }
        return n
    ...
    var I = (function () {
        ...
        return e.add = function () {
            ...
            Object.defineProperty(e, "legacy", {
                set: function (e) {
                    ...
                    e ? n.forEach(function (e) {
                        PIXI.LoaderResource.setExtensionXhrType(e, PIXI.LoaderResource.XHR_RESPONSE_TYPE.DEFAULT),
                            PIXI.LoaderResource.setExtensionLoadType(e, PIXI.LoaderResource.LOAD_TYPE.AUDIO)
            ...
            ,
            e.use = function (t, e) {
                t.data && -1 < j.indexOf(t.extension) ? t.sound = p().add(t.name, {
                    loaded: e,
                    preload: !0,
                    url: t.url,
                    source: t.data
    ...
    var M = (function () {
        ...
        return t.from = function (e) {
            var n = {};
            return "string" == typeof e ? n.url = e : e instanceof ArrayBuffer || e instanceof HTMLAudioElement ? n.source = e : n = e,
                (n = c({
                    autoPlay: !1,
                    singleInstance: !1,
                    url: null,
            ...
            t.prototype.resume = function () {
                return this.isPlaying = 0 < this._instances.length,
                    this.paused = !1,
                    this
            }
            ,
            ...
            t.prototype.stop = function () {
                if (!this.isPlayable)
                    return this.autoPlay = !1,
                        ...
                        this;
                this.isPlaying = !1;
                for (var t = this._instances.length - 1; 0 <= t; t--)
            ...
            t.prototype._onComplete = function (t) {
                if (this._instances) {
                    ...
                    -1 < e && this._instances.splice(e, 1),
                        this.isPlaying = 0 < this._instances.length
                }
            ...
            t.prototype._poolInstance = function (e) {
                e.destroy(),
                    t._pool.indexOf(e) < 0 && t._pool.push(e)
            }
            ,
            t._pool = [],
            t
    ...
    var T = (function () {
        ...
        return t.prototype.init = function () {
            return this.supported && (this._webAudioContext = new y),
    ...
    return PIXI.Loader.registerPlugin(I),
